...
int SAT_solve(struct SAT *sat)
{
    ...
    for(i=0; i< sat->clause[clause_it].beta; i++)
    {
        ...
        {
            // Se há ao menos uma variável sem valor atribuído na cláusula
            // defina o literal como VERDADEIRO
            ...
            // Se a atribuição causou uma cláusula FALSO,
            // faça backtracking e defina o literal como FALSO
